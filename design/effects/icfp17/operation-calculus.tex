...
$\opercalc$ extends the simply-typed lambda calculus with a notion of primitive capabilities and their operations. Every function is annotated with the effects it may incur. The static rules associate a type and a set of effects to programs. Defining and proving $\opercalc$ sound will introduce the notations and concepts needed to understand $\epscalc$, which is the more general, interesting language.
