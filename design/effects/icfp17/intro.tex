...
Thus in this scenario, capabilities can be used to reason about the effect of a large body of code based on a few annotations on the components it imports.
