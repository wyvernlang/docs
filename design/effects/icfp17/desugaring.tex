...
We use $\Unit$ to represent the absence of information, such as when a function takes no input or returns no value. Figure \ref{fig:unit_sugaring} shows a Wyvern function which takes no argument and returns nothing, and its corresponding $\epscalc$ representation.
