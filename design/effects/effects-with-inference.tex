...
\thm{Lemma 3.7. (Extension Lemma)}
{If $\Gamma \vdash e: \tau$ and $e$ is a value then $\hat e = \keywadj{label}(e) = e$ and $\Gamma \vdash e : \type{\tau}{\varepsilon}$.\\\\}
{Consider the different forms of $e$.
...
\thm{Theorem 3.7. (Extension Theorem)}
