...
\begin{itemize}
	...
	\item $\keywadj{label}(\keyw{new_\sigma} x \Rightarrow \overline{\sigma = e}) = \keywadj{new}_\sigma x \Rightarrow \keywadj{label}(\overline{\sigma = e})$
	\item $\keywadj{label}(\sigma = e) = \sigma = \keywadj{label}(e)$
	\item $\keywadj{label}(\keyw{new_d} x \Rightarrow \overline{d = e}) = \keyw{new_\sigma} x \Rightarrow \keywadj{label}(\overline{d = e})$
	\item $\keywadj{label}(\keywadj{def}~m(y : \tau_2) : \tau_3 = e) = \keywadj{def}~m(y : \tau_2) : \tau_3~\keyw{with} \Gamma \cap \keywadj{freevars}(e) = \keywadj{label}(e)$
\end{itemize}

\noindent
We abbreviate $\keywadj{labels}(e) = \hat e$ and use $\hat \varepsilon$ to refer to the set of effects with which $\hat e$ is annotated.\\

\thm{Theorem 5.9. (Preservation Under Labeling)}
...
\thm{Theorem 5.10. (Small-Step Soundness Of Labeled Programs)}
{If $e_A \longrightarrow e_B~|~\varepsilon_B$ and $e_A : \tau_A$ then $\hat e_A : \tau~\keyw{with ~\hat \varepsilon}$ where $\varepsilon_B \subseteq \hat \varepsilon$.\\\\}
