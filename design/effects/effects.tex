...
\thm{Lemma 2.2. (Substitution Lemma)}
...
\fbox{Intuition} If you substitute $z$ for something of the same type, the type of the whole expression stays the same under substitution.
\\\\}
...
\thm{Theorem 2.4. (Preservation for Mini Calculus)}
...
\thm{Theorem 2.5. (Small-Step Soundness For Mini Calculus)}
...
\thm{Theorem 2.6. (Multi-Step Soundness For Mini Calculus)}
