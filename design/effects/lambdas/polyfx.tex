...
\begin{enumerate}
	...
	\item $\hofx{\forall \Phi \subseteq \varepsilon_1. \hat \tau_2~\kw{caps} \varepsilon_2} = \varepsilon_1 \cup \hofx{[\varepsilon_1/\Phi]\hat \tau_2}$
\end{enumerate}
...
\infer[\textsc{(Safe-PolyFx)}]
	...
	{\varepsilon_2 \subseteq \varepsilon & \hosafe{\hat \tau_1}{\varepsilon} & \safe{[\varepsilon_1/\phi]\hat \tau_2}{\varepsilon}} ~~~

\infer[\textsc{(Safe-PolyType)}]
	{\safe{\polycap{X <: \hat \tau_1}{\hat \tau_2}{\varepsilon_2}}{\varepsilon}}
	{\varepsilon_2 \subseteq \varepsilon & \hosafe{\hat \tau_1}{\varepsilon} & \safe{[\hat \tau_1/X]\hat \tau_2}{\varepsilon}}
...
\infer[\textsc{(HOSafe-PolyFx)}]
	...
	{\varepsilon \subseteq \varepsilon_1 & \hosafe{[\varepsilon_1/\Phi]\hat \tau_2}{\varepsilon}}
