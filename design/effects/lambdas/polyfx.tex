...
\hat v & ::= & ~ & \bf{annotated~values} \\
	...
	& | & \lambda X <: \tau. \hat e & type~polymorphism \\
...
\noindent
\fbox{$\hat \Gamma \vdash \hat e: \hat \tau~\kw{caps} \varepsilon~\kw{with} \varepsilon$}

\[
\begin{array}{c}

\infer[\textsc{($\varepsilon$-PolyTypeAbs)}]
	{ \hat \Gamma \vdash \lambda X <: \hat \tau_1. \hat e : \poly{X <: \hat \tau_1}{\hat \tau_2}~\kw{caps} \varepsilon~\kw{with} \varnothing }
	{ \hat \Gamma, X <: \hat \tau_1 \vdash \hat e: \hat \tau_2 ~\kw{with} \varepsilon } \\[2ex]
