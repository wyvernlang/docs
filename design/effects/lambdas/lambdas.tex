...
\noindent
\fbox{Case: $\kwa{Unit}$, $\{ \bar r \}$}
Then $\kwa{annot(erase(\hat \tau), \varepsilon)} = \hat \tau$.\\

\noindent
\fbox{Case: $\hat \tau = \hat \tau_1 \rightarrow_{\varepsilon'} \hat \tau_2$, $\varepsilon \subseteq \kwa{effects}(\hat \tau)$, $\kwa{ho \hyphen safe}(\hat \tau, \varepsilon)$}

\noindent
$\kwa{effects}(\hat \tau_1 \rightarrow_{\varepsilon'} \hat \tau_2) = \kwa{ho \hyphen effects}(\hat \tau_1)~\cup~\varepsilon~\cup~\kwa{effects}(\hat \tau_2)$.

\noindent
$\kwa{ho \hyphen safe}(\hat \tau_1 \rightarrow_{\varepsilon'} \hat \tau_2, \varepsilon) = \kwa{safe}(\hat \tau_1, \varepsilon) \land \kwa{ho \hyphen safe}(\hat \tau_2, \varepsilon)$. \\
