...
\noindent
\fbox{\textsc{$\varepsilon$-Var}} Then $\hat e = y$. Either $y = x$ or $y \neq x$.
...
\noindent
\fbox{\textsc{$\varepsilon$-Resource}} Because $\hat e = r$ is a resource literal then $\hat \Gamma \vdash r: \hat \tau~\kw{with} \varnothing$. By definition, $[\hat v/x]r = r$, so $\hat \Gamma \vdash [\hat v/x]r: \hat \tau~\kw{with} \varnothing$. \\
