...
Then $\kwa{annot(erase(\hat \tau), \varepsilon)} = \hat \tau$ and both lemmas hold immediately.\\

\noindent
\fbox{Case: $\hat \tau = \hat \tau_1 \rightarrow_{\varepsilon'} \hat \tau_2$, $\kwa{effects}(\hat \tau) \subseteq \varepsilon$, $\kwa{ho \hyphen safe}(\hat \tau, \varepsilon)$} \\

$\kwa{annot(erase}(\hat \tau), \varepsilon) = \kwa{annot(erase}(\hat \tau_1)) \rightarrow_{\varepsilon'} \kwa{annot(erase}(\hat \tau_2))$

Need $\kwa{annot(erase}(\hat \tau_1)) <: \hat \tau_1$

Need $\hat \tau_2 <: \kwa{annot(erase}(\hat \tau_2))$ \\
...
Need $\kwa{annot(erase}(\hat \tau_2)) <: \hat \tau_2$

Need $\hat \tau_1 <: \kwa{annot(erase}(\hat \tau_1))$
