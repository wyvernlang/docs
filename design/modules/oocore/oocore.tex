...
\infer[\textsc{(pointsto-call-principal)}]
  {pointsto(l.m(l') \rhd e,\mu) = pointsto(l, \mu) \cup pointsto(e,\mu)}
  {l \mapsto \{ x \Rightarrow \overline{d} \}_\keywadj{stateful} \in \mu}\\[5ex]
...
\infer[\textsc{(auth-store)}]
  {auth_{store}(l,\mu) = pointsto(l, \mu)}
  {}\\[5ex]
...
\[
auth(l, l.m(l') \rhd E[e], \mu) = pointsto(l, \mu) \cup pointsto(E, \mu) \cup pointsto(e, \mu).
\]
\end{lemma}
...
&= pointsto(l, \mu) \cup auth_{stack}(l, l.m(l') \rhd E[e], \mu) & (\textsc{auth-store})\\
&= pointsto(l, \mu) \cup pointsto(E[e], \mu) \cup auth_{stack}(l, E[e], \mu) & (\textsc{auth-stack})\\
&= pointsto(l, \mu) \cup pointsto(E[e], \mu) & (\textsc{auth-stack-nocall})\\
&= pointsto(l, \mu) \cup pointsto(E, \mu) \cup pointsto(e, \mu) & (\textsc{pointsto-context-exp})
\end{align*}\qed
...
Since we are considering small-step semantics, within this evaluation step, there were no changes to $l$ and $E$, and thus $pointsto(l, \mu) = pointsto(l, \mu')$ and $pointsto(E, \mu) = pointsto(E, \mu')$. Therefore, $auth(l, l.m(l') \rhd E[e'], \mu')$ differ only by the values of $pointsto(e, \mu)$ and $pointsto(e', \mu')$. \qed
...
\noindent\textbf{Notes:}
\begin{itemize}
\item The \textit{\textbf{method return}} case of the authority safety theorem does not hold because if a method returns a  principal, the caller must already have authority over it: Assume there was a call $l_1.m(l_2)$ that returned $l_3$, and the caller of this method was $l$, then one of the follow must be true:

\begin{enumerate}
\item $l_3$ is a new principal that was created in $m()$, then $pointsto(l_3, \mu) \subseteq pointsto(l_1, \mu) \subseteq pointsto(l, \mu)$.
\item $l_3$ is an $l_1$'s field, then $pointsto(l_3, \mu) \subseteq pointsto(l_1, \mu) \subseteq pointsto(l, \mu)$.
\item $l_3$ is an $l_2$'s field, then $pointsto(l_3, \mu) \subseteq pointsto(l_2, \mu) \subseteq pointsto(l, \mu)$.
\item $l_3$ is a field value of a principal $l_4$, over which $l_1$ has authority, then $pointsto(l_3, \mu) \subseteq pointsto(l_4, \mu) \subseteq pointsto(l_1, \mu) \subseteq pointsto(l, \mu)$.
\item $l_3$ is a field value of a principal $l_4$, over which $l_2$ has authority, then $pointsto(l_3, \mu) \subseteq pointsto(l_4, \mu) \subseteq pointsto(l_2, \mu) \subseteq pointsto(l, \mu)$.
\end{enumerate}
...
\[
auth(l, l.m(l_0) \rhd E'[\keywadj{new}_s(x \Rightarrow \overline{d}_1)], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(\keywadj{new}_s(x \Rightarrow \overline{d}_1), \mu)\]
and by \textsc{pointsto-new},
\[
auth(l, l.m(l_0) \rhd E'[\keywadj{new}_s(x \Rightarrow \overline{d}_1)], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(\overline{d}_1, \mu)
\]
By Lemma 4, in the final state, we have:
\[
auth(l, l.m(l_0) \rhd E'[l_1], \mu') = pointsto(l, \mu') \cup pointsto(E', \mu') \cup pointsto(l_1, \mu').
\]
...
\[
auth(l, l.m(l_0) \rhd E'[l_1], \mu') = pointsto(l, \mu') \cup pointsto(E', \mu') \cup \{ l_1 \} \cup pointsto(\overline{d}_1, \mu')
\]
...
\[
auth(l, l.m(l_0) \rhd E'[l_1], \mu') = pointsto(l, \mu') \cup pointsto(E', \mu') \cup pointsto(\overline{d}_1, \mu')
\]
Although the memory was extended with the new object, since we are considering small-step semantics, within this evaluation step, no assignment could have taken place. Therefore, there were no changes to $l$, $\overline{d}_1$, or $E'$, and $pointsto(l, \mu) = pointsto(l, \mu')$, $pointsto(\overline{d}_1, \mu) = pointsto(\overline{d}_1, \mu')$, and $pointsto(E', \mu) = pointsto(E', \mu')$.\\
...
\noindent Let us consider $l$'s authority for the two states. By Lemma 4, in the initial state, we have:
\[
auth(l, l.m'(l_0) \rhd E'[l_1.m(l_2)], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_1.m(l_2), \mu)\]
and by \textsc{pointsto-otherexp},
\[
auth(l, l.m'(l_0) \rhd E'[l_1.m(l_2)], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_1, \mu) \cup pointsto(l_2, \mu)
\]
By Lemma 4, in the final state, we have:
\[
auth(l, l.m'(l_0) \rhd E'[l_1.m(l_2) \rhd [l_2/y] [l_1/x] e''], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_1.m(l_2) \rhd [l_2/y] [l_1/x] e'', \mu)
\]
Depending on whether $l_1$ is a principal, there are two possibilities.\\

\noindent\textit{Case $l_1$ is a principal:} By \textsc{pointsto-call-principal}, we get:
\begin{align*}
auth(l, l.m'(l_0) \rhd E'[l_1.m(l_2) \rhd [l_2/y] [l_1/x] e''], \mu) &= pointsto(l, \mu) \cup pointsto(E', \mu) \\
...
\noindent Let us consider $l$'s authority for the two states. By Lemma 4, in the initial state, we have:
\[
auth(l, l.m(l_0) \rhd E'[l.f], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l.f, \mu)
\]
and by \textsc{pointsto-otherexp},
\[
auth(l, l.m(l_0) \rhd E'[l.f], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu)
\]
By Lemma 4, in the final state, we have:
\[
auth(l, l.m(l_0) \rhd E'[l_1], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_1, \mu)
\]
As $\keyw{var} f : \tau = l_1 \in \overline{d}$, by \textsc{pointsto-varl}, \textsc{pointsto-decls}, and \textsc{pointsto-principal}, $pointsto(l_1, \mu) \subset pointsto(l, \mu)$ and
\[
auth(l, l.m(l_0) \rhd E'[l_1], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu)
\]
Thus, $auth(l, e', \mu') = auth(l, e, \mu)$ in compliance with the theorem.\\\\
...
\noindent Let us consider $l$'s authority for the two states. By Lemma 4, in the initial state, we have:
\[
auth(l, l.m'(l_0) \rhd E'[l.f = l_1], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l.f = l_1, \mu)\]
and by \textsc{pointsto-otherexp},
\[
auth(l, l.m'(l_0) \rhd E'[l.f = l_1], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_1, \mu)
\]
By Lemma 4, in the final state, we have:
\[
auth(l, l.m'(l_0) \rhd E'[l_1], \mu') = pointsto(l, \mu') \cup pointsto(E', \mu') \cup  pointsto(l_1, \mu')
...
\noindent Let us consider $l$'s authority for the two states. By Lemma 4, in the initial state, we have:
\[
auth(l, l.m'(l_0) \rhd E'[\keyw{bind} x = l_1~\keyw{in} e''], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(\keyw{bind} x = l_1~\keyw{in} e'', \mu)
\]
and by \textsc{pointsto-otherexp},
\[
auth(l, l.m'(l_0) \rhd E'[\keyw{bind} x = l_1~\keyw{in} e''], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_1, \mu) \cup pointsto(e'', \mu)
\]
By Lemma 4, in the final state, we have:
\[
auth(l, l.m'(l_0) \rhd E'[[l_1/x] e''], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto([l_1/x] e'', \mu)
\]
and by \textsc{pointsto-otherexp},
\[
auth(l, l.m'(l_0) \rhd E'[[l_1/x] e''], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_1, \mu) \cup pointsto(e'', \mu)
\]
Thus, $auth(l, e', \mu') = auth(l, e, \mu)$ in compliance with the theorem.\\\\
...
\[
auth(l, l.m'(l_0) \rhd E'[l_3], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_3, \mu)
\]
By Lemma 4, in the initial state, we have:
\[
auth(l, l.m'(l_0) \rhd E'[l_1.m(l_2) \rhd l_3], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_1.m(l_2) \rhd l_3, \mu).
\]
Depending on whether $l_1$ is a principal, there are two possibilities.\\

\noindent\textit{Case $l_1$ is a principal:} By \textsc{pointsto-call-principal}, we get:
\[
auth(l, l.m'(l_0) \rhd E'[l_1.m(l_2) \rhd l_3], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_1, \mu) \cup pointsto(l_3, \mu)
\]
Thus, $auth(l, e', \mu') \subset auth(l, e, \mu)$ in compliance with the theorem.
\\

\noindent\textit{Case $l_1$ is pure:} By \textsc{pointsto-call-data}, we get:
\[
auth(l, l.m'(l_0) \rhd E'[l_1.m(l_2) \rhd l_3], \mu) = pointsto(l, \mu) \cup pointsto(E', \mu) \cup pointsto(l_3, \mu).
\]
Thus, $auth(l, e', \mu') = auth(l, e, \mu)$ in compliance with the theorem.\\
