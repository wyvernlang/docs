...
\\
\item[] \textit{Case} \textsc{DT-Var}\textit{:} $d = \keyw{var} f : \tau = v$. There are two possibilities for $v$: If $v$ is a location $l$, it is not affected by the substitution, and the desired result is immediate. If $v$ is a variable $x$, 
\\
\end{itemize}
