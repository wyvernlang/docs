...
\\
\pcase[\textsc{T-Bind}]
$e = \keyw{bind} x = e_1~\keyw{in} e_2 : \tau_2$ and, from the premise, we get
\[
\Gamma,~z : \tau'~|~\Sigma \vdash e_1 : \tau_1~~~~~x : \tau_1,~z : \tau'~|~\Sigma \vdash e_2 : \tau_2
\]
By the induction hypothesis, $\Gamma~|~\Sigma \vdash [e'/z]e_1 : \tau_1$ and $x : \tau_1~|~\Sigma \vdash [e'/z]e_2 : \tau_2$. Then, by \textsc{T-Bind}, $\Gamma~|~\Sigma \vdash \keyw{bind} x = [e'/z]e_1~\keyw{in} [e'/z]e_2 : \tau_2$, i.e. $\Gamma~|~\Sigma \vdash [e'/z](\keyw{bind} x = e_1~\keyw{in} e_2) : \tau_2$.
\\
\pcase[\textsc{T-Loc}]
