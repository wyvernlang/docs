...
\begin{pcases}
\pcase[\textsc{E-New}]
$e = E[\keywadj{new}_{\keywadj{stateful}}(x \Rightarrow \overline{d}')]$; $e' = E[l']$; and $\mu' = \mu, l' \mapsto \{ x \Rightarrow \overline{d}' \}_{\keywadj{stateful}}$. Without loss of generality, let $lookupCaller(E) = l$, such that $l \mapsto \{ x \Rightarrow \overline{d} \}_{s} \in \mu$. By \textsc{lookupCaller}, in a broader context, the following evaluation step is being made: \mbox{$l.m(l'') \rhd E'[\keywadj{new}_{\keywadj{stateful}}(x \Rightarrow \overline{d}')]~|~\mu \longrightarrow l.m(l'') \rhd E'[l']~|~\mu'$}, where there are no method call stack frames in $E'$.\\

Let us consider $l$'s authority for the two states. By Lemma 4, in the initial state, we have:
\[
auth(l, l.m(l'') \rhd E'[\keywadj{new}_{\keywadj{stateful}}(x \Rightarrow \overline{d}')], \mu) = pointsto(l, \mu) \cup pointsto(\overline{d}, \mu) \cup pointsto(E', \mu) \cup pointsto(\keywadj{new}_{\keywadj{stateful}}(x \Rightarrow \overline{d}'), \mu)\]
and by \textsc{pointsto-new},
\[
auth(l, l.m(l'') \rhd E'[\keywadj{new}_{\keywadj{stateful}}(x \Rightarrow \overline{d}')], \mu) = pointsto(l, \mu) \cup pointsto(\overline{d}, \mu) \cup pointsto(E', \mu) \cup pointsto(\overline{d}', \mu)
\]
...
\\
\pcase[\textsc{E-Field}]
$e = E[l'.f]$, $e' = E[l'']$, and $\mu' = \mu$. From the premise, we get $l' \mapsto \{ x \Rightarrow \overline{d}' \}_{s} \in \mu$ and $\keyw{var} f : \tau = l'' \in \overline{d}'$. Without loss of generality, let $lookupCaller(E) = l$, such that $l \mapsto \{ x \Rightarrow \overline{d} \}_{s} \in \mu$. By \textsc{lookupCaller}, in a broader context, the following evaluation step is being made: \mbox{$l.m(l''') \rhd E'[l'.f]~|~\mu \longrightarrow l.m(l''') \rhd E'[l'']~|~\mu'$}, where there are no method call stack frames in $E'$.\\
...
\[
auth(l, l.m(l''') \rhd E'[l'.f], \mu) = pointsto(l, \mu) \cup pointsto(\overline{d}, \mu) \cup pointsto(E', \mu) \cup pointsto(l', \mu)
\]
...
\todo{Consider the case when $l'''$ is pure.}
\[
auth(l, l.m'(l_0) \rhd E'[l'''], \mu') = pointsto(l, \mu') \cup pointsto(\overline{d}, \mu') \cup pointsto(E', \mu') \cup \{ l''' \}
\]
...
\[
auth(l, l.m'(l_0) \rhd E'[l'.m(l'') \rhd l'''], \mu) = pointsto(l, \mu) \cup pointsto(\overline{d}, \mu) \cup pointsto(E', \mu) \cup \{ l' \}.
\]
...
\item[] \textit{Case $l'$ is a principal:} By \textsc{pointsto-call-principal}, we get:
\[
auth(l, l.m(l_0) \rhd E'[l'.m(l'') \rhd [l''/y] [l'/x] e''], \mu') = pointsto(l, \mu') \cup pointsto(\overline{d}, \mu') \cup pointsto(E', \mu') \cup \{ l' \}.
\]
and by \textsc{pointsto-principal},
\[
