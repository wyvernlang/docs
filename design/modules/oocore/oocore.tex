...
\begin{theorem}[Authority Safety] If $\mu : \Sigma$, $\varnothing~|~\Sigma \vdash e : \tau$, and $(e, \mu) \stepsto (e', \mu')$, then $\forall l \in dom(\mu)$, if $auth(l, e', \mu') \supset auth(l, e, \mu)$, then one of the following holds:
