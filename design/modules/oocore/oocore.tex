...
\infer[\textsc{(T-Store)}]
  ...
  {\mu : \Sigma & \varnothing~|~\Sigma \vdash d_v : \sigma}\\[5ex]
...
%  {\keywadj{new}_{s}(x \Rightarrow d)~|~\mu \longrightarrow l \mapsto \{ x \Rightarrow d_v \}_{s}~|~\mu'}
...
\infer[\textsc{(E-Meth3)}]
  {l_1.m(l_2)~|~\mu \longrightarrow [l_2/x]e~|~\mu'}
...
\infer[\textsc{(E-Assign2)}]
  {l_1.f = e~|~\mu \longrightarrow l_2~|~\mu'}
  {l_1 \mapsto \{ x \Rightarrow d_v \}_{s} \in \mu & e~|~\mu \longrightarrow l_2~|~\mu' & \keyw{var} f:\tau = l_2 \in d_v}\\[5ex]
  
\end{array}
\]

$\fbox{$d~|~\mu \longrightarrow d'~|~\mu'$}$
\[
\begin{array}{c}
\infer[\textsc{(E-Def)}]
  {\keyw{def} m(x:\tau):\tau = e_1~|~\mu \longrightarrow \keyw{def} m(x:\tau):\tau = e_1'~|~\mu'}
  {e_1~|~\mu \longrightarrow e_1'~|~\mu'}\\[5ex] 

\infer[\textsc{(E-Var)}]
  {\keyw{var} f:\tau = e_1~|~\mu \longrightarrow \keyw{var} f:\tau = e_1'~|~\mu'}
  {e_1~|~\mu \longrightarrow e_1'~|~\mu'}\\[5ex] 
\end{array}
\]
