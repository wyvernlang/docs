...
\begin{itemize}
  ...
  \item $pointsto(l',\mu) = \{ l' \}$, \textbf{\emph{~~~[The argument $l'$ is a principle]}}
  ...
  \item $pointsto(l''',\mu) = \{ l''' \}$, \textbf{\emph{~~~[The returned $l'''$ is a principle]}}
...
\begin{pcases}
\pcase[\textsc{E-New}]
$e = \keywadj{new}_{\keywadj{stateful}}(x \Rightarrow d)$, $e' = l'$, $\mu' = \mu, l \mapsto \{ x \Rightarrow d \}_{s}$, and from the premise, we get $l \not\in dom(\mu)$ and $\keywadj{new}_{s}(x \Rightarrow d)~is~closed$.
