...
\\
$\textit{trans}(i)$ & $\equiv$ & \\
if $i = \keyw{import} M~\keyw{as} M_1; *$ & then & $\keyw{val} M_1 = M; trans(*)$ \\
if $i = \keyw{require} URI~\keyw{as} M_1; *$ & then & $ M_1 : URI,~trans(*)$ \\
if $i = \keyw{instantiate} URI(M_1^*)~\keyw{as} M; *$ & then & $ \keyw{val} M = URI(M_1^*); trans(*)$\\
