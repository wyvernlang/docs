...
\infer[\textsc{(T-MethApp)}]
	...
	{\Gamma~|~\Sigma \vdash e_2 : \tau_1 & \Gamma~|~\Sigma \vdash e : \tau & \tau=\{..., \keyw{def}~ m : \tau_1 \rightarrow \tau_2, ... \} }\\[5ex]
...
\infer[\textsc{(T-Assign)}]
	...
	{\Gamma~|~\Sigma \vdash e : \sigma & \sigma= \{\keyw{var}~ f:\tau_1,... \} & \Gamma~|~\Sigma \vdash e_2 : \tau_1 }\\[5ex]
...
\infer[\textsc{(T-StackFrames)}]
	{\Gamma~|~\Sigma \vdash l_1.m(l_2) \rhd e}
	{\Gamma~|~\Sigma \vdash l_2 : \tau_1 & \Gamma~|~\Sigma \vdash l_1 : \tau & \tau = \{..., \keyw{def}~ m : \tau_1 \rightarrow \tau_2, ... \}} \\[5ex]
