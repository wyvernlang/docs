...
\item The \textsc{auth-stack} rule ``zooms out'' from the evaluation context.
...
).mp(new($l_I$ => var xi : Int = 3), new($l_H$ => def mh(y : typeOfI) : Int = y.xi)).mj()
\end{lstlisting}
...
\newpage
%\vspace{12pt}
\noindent Evaluation step 11 (form before: $E.m(e)$, substitution of concrete objects for variables):
\vspace{-6pt}
\begin{lstlisting}[xleftmargin=20pt]
$l_p \rightarrow \{$   def mp(yi : typeOfI, yh : typeOfH) : typeOfJ =
         new($l_J$ =>
...
$l_J$.mj() $\rhd$ $l_H$.mh(xji)
\end{lstlisting}

\vspace{12pt}
\noindent Evaluation step 11 (form before: $l.m(E)$, substitution of concrete objects for variables):
\vspace{-6pt}
\begin{lstlisting}[xleftmargin=20pt]
$l_p \rightarrow \{$   def mp(yi : typeOfI, yh : typeOfH) : typeOfJ =
         new($l_J$ =>
...
$l_J$.mj() $\rhd$ ($l_H$.mh($l_I$) $\rhd$ y.xi)
\end{lstlisting}

\newpage
%\vspace{12pt}
\noindent Evaluation step 13 (form before: $l.m(l) \rhd E$, rule applied: \textsc{E-Meth}):
\vspace{-6pt}
\begin{lstlisting}[xleftmargin=20pt]
$l_p \rightarrow \{$   def mp(yi : typeOfI, yh : typeOfH) : typeOfJ =
         new($l_J$ =>
...
\vspace{12pt}
\noindent Evaluation step 14 (form before: $l.f$, evaluating):
\vspace{-6pt}
\begin{lstlisting}[xleftmargin=20pt]
$l_p \rightarrow \{$   def mp(yi : typeOfI, yh : typeOfH) : typeOfJ =
         new($l_J$ =>
