...
\infer[\textsc{(DT-DefPure)}]
  ...
  \begin{array}{c}
\Gamma_{stateful} = \{x : \{ x \Rightarrow \sigma \}_{\keyw{stateful}} ~|~ x : \{ x \Rightarrow \sigma \}_{\keyw{stateful}} \in \Gamma\} \\
...
\infer[\textsc{(S-Obj)}]
  {\{ x \Rightarrow \sigma \}_{s} <: \{ x \Rightarrow \sigma' \}_{s}}
  {\sigma <: \sigma'}\\[5ex]  
...
\infer[\textsc{(E-Def)}]
  {\keyw{def} m(x:\tau):\tau = e; d~|~\mu \longrightarrow \keyw{def} m(x:\tau):\tau = e; d_v~|~\mu'}
  {}\\[5ex]

\infer[\textsc{(E-Var)}]
  {\keyw{var} f:\tau = e; d~|~\mu \longrightarrow \keyw{var} f:\tau = l; d_v~|~\mu'}
  {}\\[5ex]

\infer[\textsc{(E-Field2)}]
  {e.f = e~|~\mu \longrightarrow e.f = l~|~\mu'}
  {e~|~\mu \longrightarrow l~|~\mu'}%\\[5ex]  
~~~~~~~~~~
\infer[\textsc{(E-Meth)}]
  {e_1.m(e_2)~|~\mu \longrightarrow l_1.m(l_2) \rhd e~|~\mu'}
  {e_1~|~\mu \longrightarrow l_1~|~\mu' & e_2~|~\mu \longrightarrow l_2~|~\mu'}\\[5ex]  
