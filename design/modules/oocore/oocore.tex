...
\infer[\textsc{(T-Var)}]
  ...
  {x : \tau \in \Gamma}\\[5ex]
%~~~~~~~~~~
\infer[\textsc{(T-New-New)}]
  {\Gamma~|~\Sigma \vdash \keywadj{new}_{s}(x \Rightarrow \overline{d}) : \{ \overline{\sigma_e} \}_{s}}
  {\def\arraystretch{1.5}
  \begin{array}{c}
\Gamma_{external} = \{x : \{ \overline{\sigma_e'} \}_s ~|~ x : \{  \overline{\sigma_e'} \}_s \in \Gamma \} \\\Gamma_{externalized} = \{x : \{ \overline{\sigma_e''} \}_s ~|~\overline{\sigma_e''} = \{ \keyw{def} m : \tau_2 \rightarrow \tau_1~|~\keyw{def} m : \tau_2 \rightarrow \tau_1 \in \overline{\sigma_i} \} \land x : \{ \overline{\sigma_i} \}_s \in \Gamma \} \\
\Gamma_{external},~\Gamma_{externalized},~x : \{ \overline{\sigma_i} \}_{s}~|~\Sigma \vdash_s \overline{d} : \overline{\sigma_i}~~~~~\overline{\sigma_e} = \{ \keyw{def} m : \tau_2 \rightarrow \tau_1~|~\keyw{def} m : \tau_2 \rightarrow \tau_1 \in \overline{\sigma_i} \}
  \end{array}}\\[5ex]

\infer[\textsc{(T-New-Old)}]
	{\Gamma~|~\Sigma \vdash \keywadj{new}_{s}(x \Rightarrow \overline{d}) : \{ \overline{\sigma_e} \}_{s}}
