...
\infer[\textsc{(T-Meth)}]
	...
	{\Gamma~|~\Sigma \vdash e_1 : \{ \overline{\sigma_i} \}_s  & \keyw{def}~ m : \tau_2 \rightarrow \tau_1 \in \overline{\sigma_i} & \Gamma~|~\Sigma \vdash e_2 : \tau_2}\\[5ex]
...
\infer[\textsc{(T-StackFrames)}]
	...
	{\Gamma~|~\Sigma \vdash l_1 : \{ \overline{\sigma_i} \}_s & \keyw{def}~ m : \tau_2 \rightarrow \tau_1 \in \overline{\sigma_i} & \Gamma~|~\Sigma \vdash l_2 : \tau_2 & \Gamma~|~\Sigma \vdash e : \tau_1} \\[5ex]
...
\infer[\textsc{(pointsto-varx)}]
  {pointsto(\keyw{var} f:\tau = x; d,\mu) = pointsto(d,\mu)}
  {}\\[5ex]
