...
\\
\item[]  \textit{Subcase} \textsc{E-Field}\textit{:} In this case, $e$ is a value, i.e. a location $l_1$. Then, from  \textsc{T-Field}, we have $\Gamma~|~\Sigma \vdash e : \{\sigma\}_s$ and $\keyw{var}~ f : \tau \in \sigma$. By \textsc{T-Store}, we know that the store is well formed, and by \textsc{T-Field}, we have $\Gamma~|~\Sigma \vdash l_1 : \tau$, and therefore, the right-hand side is well typed.
\\
\end{itemize}
