...
%\vspace{20pt}
%
%\noindent\underline{\smash{\textbf{\textit{Field assignment:}}}}
%
%\vspace{16pt}
%
...
%new($l_A$ =>
%  def m(y : $\tau_1$) : $\tau_2$ =
%    new($l_C$ => var $f$ : $\tau_1$ = y)
%  ).m(new($l_B$ => var $f_1$ : $\tau_3$ = 10)).$f$ = new($l_B$ => var $f_1$ : $\tau_3$ = 8)
%\end{lstlisting}
%
%\vspace{6pt}
%\noindent Heap just before assignment:
%\vspace{-6pt}
%\begin{lstlisting}[xleftmargin=20pt]
%$l_A \rightarrow \{$ def m(y : $\tau_1$) : $\tau_2$ =
%          new($l_C$ => var $f$ : $\tau_1$ = y) $\}$
%          
%$l_C \rightarrow \{$ var $f$ : $\tau_1$ = $l_B$ $\}$
%
%$l_B \rightarrow \{$ var $f_1$ : $\tau_3$ = 10 $\}$
%
%$l_D \rightarrow \{$ var $f_1$ : $\tau_3$ = 8 $\}$
%\end{lstlisting}
%\[
%\infer[\textsc{(E-Assign)}]
%  {l_C.f = l_D~|~\mu \longrightarrow l_D~|~\mu'}
%  {\def\arraystretch{1.6}
%  \begin{array}{c}
%l_C \mapsto \{ x \Rightarrow \overline{d_C} \}_{s} \in \mu~~~~~~~~~~~\keyw{var} f : \tau_1 = l_B \in \overline{d_C} \\
%\overline{d_C}' = [\keyw{var} f : \tau_1 = l_D/\keyw{var} f : \tau_1 = l_B]\overline{d_C}~~~~~\mu' = [l_C \mapsto \{ x \Rightarrow \overline{d_C}' \}_{s}/l_C \mapsto \{ x \Rightarrow \overline{d_C} \}_{s}]\mu
%  \end{array}}\\[5ex]
%\]
...
\noindent\fbox{\parbox{\widthof{Subcase \textsc{E-Meth}:}}{Subcase \textsc{E-Meth}:}}
