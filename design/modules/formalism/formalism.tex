...
\infer[\textsc{(T-Module-Version1)}]
  {\Gamma~|~\Sigma \vdash \keyw{module} m : S}
  {\keyw{module} m : S \in \Gamma}\\[5ex]

\infer[\textsc{(T-Module-Version2)}]
  {\Gamma~|~\Sigma \vdash \keyw{module} m : S}
  {\def\arraystretch{1.6}
  \begin{array}{c}
\keyw{module} m = \{d_1, ..., d_n\}~~~~~S = \{DT_1, ..., DT_n\}~~~~~\Gamma~|~\Sigma \vdash d_1 : DT_1 \\
