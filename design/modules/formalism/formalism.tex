...
\infer[\textsc{(T-AbsWithState)}]
  ...
  {\Gamma,~x : \tau_1,~\reftt e_3 : \Reftt \tau~|~\Sigma \vdash e_2 : \tau_2}\\[5ex]
...
\infer[\textsc{(T-AppWithState)}]
  {\Gamma,~\reftt e_3 : \Reftt \tau~|~\Sigma \vdash e_1~e_2 : \tau_2}
  {\Gamma,~\reftt e_3 : \Reftt \tau~|~\Sigma \vdash e_1 : \tau_1 \xrightarrow{s} \tau_2
