...
\inferrule
  ...
  {\Delta \vdash T_1 \equiv T_2}
  \quad (\textsc{Eq-Assume})
  \and
\inferrule
  {
  \Delta, \{z \Rightarrow \overline{\sigma}_1\} \equiv \{z \Rightarrow \overline{\sigma}_2\} \vdash \overline{\sigma}_1 \equiv \overline{\sigma}_2
  }
...
\inferrule
  ...
  \quad (\textsc {T-Type})
	\and
\inferrule
  {A; \Sigma; \Gamma, (x : U) \vdash e : T \\
   A; \Sigma; \Gamma \vdash e' : S\\
   A; \Sigma; \Gamma \vdash S <: U}
  {A; \Sigma; \Gamma \vdash \texttt{let} \; x : U = e' \; \texttt{in} \; e : T}
  \quad (\textsc {T-Let})
\end{mathpar}
