...
\inferrule
	...
	\and
\inferrule
	{\Sigma; \Gamma \vdash \sigma <: \sigma_1 \\
	 \Sigma; \Gamma \vdash \sigma <: \sigma_2}
	{\Sigma; \Gamma \vdash \sigma <: \sigma_1 \wedge \sigma_2}
	\quad (\textsc {S-Decl-Intersection})
	\and
\inferrule
	{\Sigma; \Gamma \vdash \sigma_1 <: \sigma}
	{\Sigma; \Gamma \vdash \sigma_1 \wedge \sigma_2 <: \sigma}
	\quad (\textsc {S-Decl-Intersection-L})
	\and
\inferrule
	{\Sigma; \Gamma \vdash \sigma_2 <: \sigma}
	{\Sigma; \Gamma \vdash \sigma_1 \wedge \sigma_2 <: \sigma}
	\quad (\textsc {S-Decl-Intersection-R})
\end{mathpar}
\caption{Subtyping}
\label{f:subtype}
\end{figure}
