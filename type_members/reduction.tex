...
\inferrule
  {\mu' = \mu, y \mapsto \{\texttt{self} \Rightarrow \overline{d_v}\} \\
  	E' = E[\texttt{var} \; y = \texttt{new} \; \{\texttt{self} \Rightarrow \overline{d_v}\}; \bigcirc]}
  {\mu \; | \; \texttt{var} \; y = \texttt{new} \; \{\texttt{self} \Rightarrow \overline{d_v}\}; e \; | E \; \rightarrow \mu' \; | \; e \; | E'}
  \quad (\textsc {R-New})
  \and
\inferrule
  {\mu(narrow(v_1)) = \{\texttt{self} \Rightarrow ...,m:T(x:S)=e,...\}}
  {\mu \; | \; v_1.m(v_2) \; | E \rightarrow \mu \; | \; [v_1/\texttt{self},v_2 \unlhd S/x]e \unlhd T \; | E}
  \quad (\textsc {R-Meth})
%  \and
%\inferrule
%  {}
...
\inferrule
  ...
  {\mu \; | \; v_1.f \; | E \rightarrow 	\mu \; | \; [v_1 \unlhd T/\texttt{self}]e \; | E}
  \quad (\textsc {R-Acc})
%  \and
%\inferrule
%  {narrow(v_1) = x \\
