...
Reduction isn't the only place narrowing occurs. Narrowing is also required as part of subtyping structural types.
\begin{block}{Structural Subtyping}
\begin{mathpar}
\inferrule
...
\begin{block}{Structural Subtyping Patched}
\begin{mathpar}
\inferrule
