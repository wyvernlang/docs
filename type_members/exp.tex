...
\inferrule
  {}
  {\Gamma \vdash \{z \Rightarrow \overline{\sigma}\} \prec_z \overline{\sigma}}
  \quad (\textsc {E-Rec})
	\and
\inferrule
  {\Gamma \vdash p \ni \texttt{type} \; L : S..U \\
  	\Gamma \vdash U \prec_z \overline{\sigma}}
  {\Gamma \vdash p.L \prec_z \overline{\sigma}}
  \quad (\textsc {E-Sel})
	\and
\inferrule
  {}
  {\Gamma \vdash \top \prec_z \varnothing}
  \quad (\textsc {E-Top})
\end{mathpar}
\caption{Expansion}
\label{f:exp}
...
\inferrule
  {\Gamma \vdash p : T \\
  	\Gamma \vdash T \prec_z \overline{\sigma}\\
