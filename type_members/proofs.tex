...
\begin{lemma}[Subtype Transitivity]\label{thm:trans}
If $\Sigma; \Gamma_1 \vdash S <: T \dashv \Gamma_2$ and
   $\Sigma; \Gamma_2 \vdash T <: U \dashv \Gamma_3$ then
	$\Sigma; \Gamma_1 \vdash S <: U \dashv \Gamma_3$.
\end{lemma}
\begin{proof}
By induction on $\Sigma; \Gamma_1 \vdash S <: T \dashv \Gamma_2$.
\end{proof}
\qed
