...
\begin{mathpar}
\inferrule
  {\varnothing; \Sigma; \Gamma_1, (x : U), \Gamma_2 \vdash e : T \\
  	x \notin \, \Gamma_1\\
  	\varnothing; \Sigma; \Gamma_1 \vdash p : S \\
  	\varnothing; \Sigma; \Gamma_1 \vdash S <: U \dashv \Gamma_1}
  {\varnothing; \Sigma; , \Gamma_1, [p \unlhd U/x]\Gamma_2 \vdash [p \unlhd U/x]e : [p \unlhd U/x]T}
\end{mathpar}
\end{lemma}
\begin{proof}
By structural induction on 
...
\inferrule
  ...
  {	\varnothing; \Sigma; \Gamma_1, (x : U), \Gamma_2 \vdash y : \Gamma_1, (x : U), \Gamma_2(y)}
\end{mathpar}
...
$x$, $[p\unlhd U/x]U = U$.
By assumption we have $\varnothing; \Sigma; \Gamma_1 \vdash p : S$ 
and $\varnothing; \Sigma; \Gamma_1 \vdash S <: U \dashv \Gamma_1$.
\hl{Weakening} gives us 
\begin{mathpar}
\inferrule
  {\varnothing; \Sigma; \Gamma_1, [p\unlhd U/x]\Gamma_2 \vdash p : S \\
  	\varnothing; \Sigma; \Gamma_1, [p\unlhd U/x]\Gamma_2 \vdash S <: U \dashv \Gamma_1, [p\unlhd U/x]\Gamma_2}
  {}
\end{mathpar}
...
$\varnothing; \Sigma; \Gamma_1, [p\unlhd U/x]\Gamma_2 \vdash y : \Gamma_1, [p\unlhd U/x]\Gamma_2(y)$.
\end{subcase}
\end{casethm}
...
\inferrule
  {	l \in dom(\Sigma)}
  {	\varnothing; \Sigma; \Gamma, (x : U) \vdash l : \Sigma(l)}
\end{mathpar}
Trivial.
\end{casethm}
...
\begin{mathpar}
\inferrule
  {\varnothing; \Sigma; \Gamma_1, (x : U), \Gamma_2, z : \{z \Rightarrow \overline{\sigma}\} 
  \vdash \overline{d} : \overline{\sigma}}
  {\varnothing; \Sigma; \Gamma_1, (x : U), \Gamma_2 \vdash \texttt{new} \; \{z \Rightarrow \overline{d}\} : 
  \{z \Rightarrow \overline{\sigma}\}}
\end{mathpar}
By our induction hypothesis we assume 
\begin{mathpar}
\inferrule
  {\varnothing; \Sigma; \Gamma_1, [p\unlhd U/x]\Gamma_2, z : \{z \Rightarrow [p\unlhd U/x] \overline{\sigma}\} 
...
\begin{mathpar}
\inferrule
  {\varnothing; \Sigma; \Gamma_1, [p\unlhd U/x]\Gamma_2 \vdash \texttt{new} \; \{z \Rightarrow [p\unlhd U/x]\overline{d}\} : 
...
\begin{mathpar}
\inferrule
  {\varnothing; \Sigma; \Gamma_1, (x : U), \Gamma_2 \vdash e_0 \ni \texttt{def} \; m:S \rightarrow T \\
  	\varnothing; \Sigma; \Gamma_1, (x : U), \Gamma_2 \vdash e_0 : T_0 \\
  	\varnothing; \Sigma; \Gamma_1, (x : U), \Gamma_2 \vdash e_1 : S' \\
  	\varnothing; \Sigma; \Gamma_1, (x : U), \Gamma_2 \vdash S' <: S \dashv \Gamma_1, (x : U), \Gamma_2 \\
  	\varnothing; \Sigma; \Gamma_1, (x : U), \Gamma_2 \vdash T <: U \dashv \Gamma_1, (x : U), \Gamma_2}
  {\varnothing; 	\Sigma; \Gamma_1, (x : U), \Gamma_2 \vdash e_0.m_U(e_1) : U}
\end{mathpar}
\end{casethm}
...
\begin{mathpar}
\inferrule
  {	\varnothing; \Sigma; \Gamma, (x : U) \vdash e : S \\
  	\varnothing; \Sigma; \Gamma, (x : U) \vdash e \ni \texttt{val} \; f:T}
  {	\varnothing; \Sigma; \Gamma, (x : U) \vdash e.f : T}
\end{mathpar}
\end{casethm}
...
\inferrule
  {\varnothing; \Sigma; \Gamma, (x : U) \vdash e : S \\
   \varnothing; \Sigma; \Gamma, (x : U) \vdash S <: T \dashv \Gamma}
  {\varnothing; \Sigma; \Gamma, (x : U) \vdash e \unlhd T : T}
\end{mathpar}
\end{casethm}
