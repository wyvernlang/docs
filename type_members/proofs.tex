...
\begin{lemma}[Transitive Expansion] \label{lem:equiv_subst}
\begin{mathpar}
\inferrule
...
\inferrule
	{p \equiv p' \\
	 \varnothing; \Sigma; \Gamma_1 \vdash p : S, p' : S \\
	 \varnothing; \Sigma; \Gamma_1, (x : S), \Gamma_2 \vdash T <: T}
	{\varnothing; \Sigma; \Gamma_1, [p/x]\Gamma_2 \vdash [p/x]T <: [p'/x]T}
	\and
\inferrule
	{p \equiv p' \\
	 \varnothing; \Sigma; \Gamma_1 \vdash p : S, p' : S \\
	 \varnothing; \Sigma; \Gamma_1, (x : S), \Gamma_2 \vdash T \prec_z \overline{\sigma}}
	{\varnothing; \Sigma; \Gamma_1, [p/x]\Gamma_2 \vdash [p/x]\overline{\sigma} <: [p'/x]\overline{\sigma}}
\end{mathpar}
\end{lemma}
