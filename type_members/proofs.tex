...
\begin{lemma}[Environment Equivalence]
\begin{mathpar}
\inferrule
  {A; \Sigma; \Gamma \vdash  T_1 \equiv T_2}
  {A; \Sigma; \Gamma \vdash  T_1 <: T_2}
%  \and
%\inferrule
%  {A; \Sigma; \Gamma_1, x : T_1, \Gamma_2 \vdash  T_1 \equiv T_2\\
%   A; \Sigma; \Gamma_1, x : T_1, \Gamma_2 \vdash  e : T\\
%   A; \Sigma; \Gamma_1, x : T_2, \Gamma_2 \vdash  e : T'}
%  {A; \Sigma; \Gamma_1, x : T_2, \Gamma_2 \vdash  T \equiv T'}
%  \and
%\inferrule
%  {A; \Sigma; \Gamma_1, x : T_1, \Gamma_2 \vdash  T_1 \equiv T_2\\
%   A; \Sigma; \Gamma_1, x : T_1, \Gamma_2 \vdash  T <: T'}
%  {A; \Sigma; \Gamma_1, x : T_2, \Gamma_2 \vdash  T <: T'}
%  \and
%\inferrule
%  {A; \Sigma; \Gamma_1, x : T_1, \Gamma_2 \vdash  T_1 \equiv T_2\\
%   A; \Sigma; \Gamma_1, x : T_1, \Gamma_2 \vdash  T \prec \overline{\sigma}\\
%   A; \Sigma; \Gamma_1, x : T_2, \Gamma_2 \vdash  T \prec \overline{\sigma}'}
%  {A; \Sigma; \Gamma_1, x : T_2, \Gamma_2 \vdash  \overline{\sigma} \equiv \overline{\sigma}'}
%  \and
%\inferrule
%  {A; \Sigma; \Gamma_1, x : T_1, \Gamma_2 \vdash  T_1 \equiv T_2\\
%   A; \Sigma; \Gamma_1, x : T_1, \Gamma_2 \vdash  T \ni \sigma\\
%   A; \Sigma; \Gamma_1, x : T_2, \Gamma_2 \vdash  T \ni \sigma'}
%  {A; \Sigma; \Gamma_1, x : T_2, \Gamma_2 \vdash  \sigma \equiv \sigma'}
\end{mathpar}
\end{lemma}
\begin{proof}
By induction on 
...
\inferrule
  ...
  {A; \Sigma; \Gamma_1, x : T_1, \Gamma_2 \vdash \{z \Rightarrow \overline{\sigma}_1\} \equiv \{z \Rightarrow \overline{\sigma}_2\}}
\end{mathpar}
...
\inferrule
  ...
  {}
\end{mathpar}
Thus by \textsc{S-Rec} we have $A; \Sigma; \Gamma \vdash \{z \Rightarrow \overline{\sigma}_1\} <: \{z \Rightarrow \overline{\sigma}_2\}$
\end{casethm}
