...
\begin{mathpar}
  ...
  \and
\inferrule
  {\mu \vdash v_1 \leadsto v_2}
  {\mu \vdash v_1 \unlhd T \leadsto v_2 \unlhd T}
\end{mathpar}
...
If $A; \Sigma; \Gamma \vdash S <: T \dashv \Gamma$ and 
   $A; \Sigma; \Gamma \vdash T <: U \dashv \Gamma$ then
   $A; \Sigma; \Gamma \vdash S <: U \dashv \Gamma$.
\end{lemma}
\begin{proof}
...
\begin{lemma}[Subtype Expansion] \label{lem:subtype_expansion}
\begin{mathpar}
\inferrule
...
\inferrule
  {A; \Sigma; \Gamma_1 \vdash p \ni \texttt{type} \; L : S' .. U'\\
  	A; \Sigma; \Gamma_1 \vdash S' <: U' \dashv \Gamma_1 \\
  	A; \Sigma; \Gamma_1 \vdash U' <: T' \dashv \Gamma_2}
  {A; \Sigma; \Gamma_1 \vdash p.L\; <:\; T \dashv \Gamma_2}
\end{mathpar}
...
\begin{lemma}[Field Leadsto type Preservation] \label{lem:field_leadsto_preservation}
...
\inferrule
  {\mu; \Sigma \vdash v_1 \leadsto v_2 \\
   \mu; \Sigma \vdash v_2 \leadsto_{f} v_f}
  {\mu; \Sigma \vdash v_1.f \leadsto v_f}
\end{mathpar}
...
$A; \Sigma; \Gamma_1 \vdash p_1.L \prec_z \overline{\sigma}_1$ and
$A; \Sigma; \Gamma_1 \vdash p_2.L \prec_z \overline{\sigma}_2$ we have 
\begin{mathpar}
\inferrule
	{}
	{A; \Sigma; \Gamma_1 \vdash U_1 \prec_z \overline{\sigma}_1 \\
	 A; \Sigma; \Gamma_1 \vdash U_2 \prec_z \overline{\sigma}_2}
\end{mathpar}
Since $A, (p_1.L <: p_2.L); \Sigma; \Gamma \vdash U_1\; <:\; U_2$ 
by our induction hypothesis we assume that 
\begin{mathpar}
\inferrule
	{}
	{A; \Sigma; \Gamma_1,(z:U_1) \vdash \overline{\sigma}_1 <:^* [z \unlhd U_2 / z]\overline{\sigma}_2}
\end{mathpar}
\end{casethm}
