...
\end{lstlisting}
\vspace{-8px}
\caption{The `simpleHTML' keyword example. \todo{color quotations}\todo{set uniform spacing for whole document}}
\vspace{-10px}
\label{f-simplehtml}
\end{figure}
...
Type Keyword Context & $\Delta_\kappa$ & ::= & $\emptyset$\\
            &                 &  |   & $\Delta_{\kappa};k[i,\tau]$\\
