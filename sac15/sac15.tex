...
\par
Using TSL method, DSL literals(HTML) can be safely injected into Wyvern, and due to its type specific property, composing different DSL syntax in Wyvern can be easily achieved. 


\section{Extensible keywords in Wyvern}
In this section, we present several examples of both expression keywords and type keywords in Wyvern language. 
