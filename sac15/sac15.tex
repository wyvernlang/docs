...
\begin{figure}[ht]
  ...
  \begin{array}{ll}
      ...
      \text{Declarations}\\
      \theta~::=~\emptyset      &\\
      \tabularspace\theta;k[\mathbf{ty},e,\tau] & \textcd{typekw}~k~\textcd{with metadata:}\tau~\textcd{=}~e\\
      \tabularspace\theta;k[\mathbf{bk}(\tau),e]    & \textcd{expkw}~k : \tau~\textcd{=}~e\\
      \tabularspace\theta;k[\mathbf{wk},e]          & \textcd{expkw}~k~\textcd{=}~e\\
