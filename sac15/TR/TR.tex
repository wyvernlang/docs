...
\]
\end{definition}
Intuitively, $\Theta_1\Theta_2$ (or $\Delta_1\Delta_2$) represents ``update'' the context $\Theta_1$ using the context $\Theta_2$ by adding new elements from $\Theta_2$ and update old elements in $\Theta_1$ with new fields, while keeping elements appeared only in $\Theta_1$ untouched.
