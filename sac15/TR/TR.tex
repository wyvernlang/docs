...
\begin{center}
\AXC{$\vdash_{\Theta} i\Leftarrow MemberList$ ~~~~ $i_l\uparrow l$ ~~~~ $\vdash_{\Theta} i_t\uparrow \tau$ ~~~~ $\vdash_{\Theta} i_c\uparrow \omega$}
...
\begin{center}
\AXC{$\vdash_{\Theta} i\Leftarrow CaseList$ ~~~~ $i_l\uparrow C$ ~~~~ $\vdash_{\Theta} i_t\uparrow \tau$ ~~~~ $\vdash_{\Theta} i_c\uparrow \chi$}
