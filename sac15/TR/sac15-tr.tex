...
For concision and readability consideration, before we introduce the full formal definition, we first introduce the core syntax and semantics for TSMs with explanations.
