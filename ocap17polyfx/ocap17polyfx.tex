...
%
%In this OCAP 2017 talk we will describe our progress on effect inference and how it can benefit from capabilities as well as discuss our later work on polymorphic effect inference.~\footnote{This paper is a cut down version of our larger publication under consideration for another ACM conference and thus will not be published but only presented at the workshop for the discussion purposes.}
%
