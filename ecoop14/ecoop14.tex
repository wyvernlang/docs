...
numbers=left, numberstyle=\scriptsize\color{gray}\ttfamily, language=java,moredelim=[il][\sffamily]{?},mathescape=true,showspaces=false,showstringspaces=false,xleftmargin=15pt,escapechar=@, morekeywords=[1]{let,fn,val},deletekeywords={for,double},classoffset=0,belowskip=\smallskipamount,
...
moredelim=**[is][\color{gray}]{SNAT}{ENDNAT}, % UNREADABLE COLOUR!
