...
numbers=left, numberstyle=\scriptsize\color{gray}\ttfamily, language=java,moredelim=[il][\sffamily]{?},mathescape=true,showspaces=false,showstringspaces=false,xleftmargin=15pt,escapechar=@, morekeywords=[1]{let,fn,val},deletekeywords={for},classoffset=0,belowskip=\smallskipamount,
moredelim=**[is][\color{cyan}]{STR}{STR},
moredelim=**[is][\color{red}]{TSL1}{TSL1},
moredelim=**[is][\color{blue}]{TSL2}{TSL2},
moredelim=**[is][\color{purple}]{TSL3}{TSL3},
moredelim=**[is][\color{orange}]{TSL4}{TSL4},
moredelim=**[is][\color{green}]{TSL5}{TSL5}, % UNREADABLE COLOUR!
moredelim=**[is][\color{yellow}]{TSL6}{TSL6} % UNREADABLE COLOUR!
}
