...
\abstract{
  We present additional details on our static semantics and our corpus analysis that were omitted from the main body of the paper \emph{Safely Composable Type-Specific Languages} for concision \cite{TSLs}.
}
