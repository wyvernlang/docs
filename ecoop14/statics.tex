...
\infer[\textit{Dyn-Meta}]
	{t.\keyw{metaobject} \xmapsto[\Sigma,t\triangleright \hat{e}]{} \hat{e}} 
	{}\\[3ex]

\infer[\textit{Dyn-valAST1}]
	{valAST(\hat{e}) \xmapsto[\Sigma]{} valAST(\hat{e}') } 
	{\hat{e} \xmapsto[\Sigma]{} \hat{e}'}\\[3ex]

\infer[\textit{Dyn-valAST2}]
	{valAST(\hat{e}) \xmapsto[\Sigma]{} \hat{e}' } 
