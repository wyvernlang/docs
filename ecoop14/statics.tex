...
The rule \textit{T-varx} synthesizes the type of the variable $x$ to be $\tau$, if the variable context $\Gamma$ contains the $x:\tau$ declaration. 
...
The rule \textit{T-introcase} 

The rules \textit{T-elimcase}, \textit{T-casehelper1} and \textit{T-casehelper2}
