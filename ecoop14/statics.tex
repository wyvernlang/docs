...
\infer[\textit{RT-objtype}]
	...
	{\Delta \vdash \omega & \Delta; \Gamma \vdash e \Rightarrow\tau \leadsto \hat{e} & \Delta, t:\{\omega,e_0:\tau\}; \Gamma \vdash \rho }\\[3ex]

\infer[\textit{RT-casetype}]
	{\Delta; \Gamma \vdash  \keyw{casetype}~ t~=\{\chi, \keyw{metaobject}=e\}; \rho} 
	{\Delta \vdash \chi & \Delta; \Gamma \vdash e \Rightarrow\tau \leadsto \hat{e} & \Delta, t:\{\chi,e_0:\tau\}; \Gamma \vdash \rho  }\\[3ex]
