...
\infer[\textit{RExp-FromTS}]
          {\renewcommand{\arraystretch}{1}
	    \begin{array}{r}
	    fromTS[\Gamma](e_1,e_2) \triangleright_{\Gamma}\\
           Exp.FromTS(\hat{e}_1,\hat{e}_2)
            \end{array}
       }
	  {e_1 \triangleright_{\Gamma} \hat{e}_1 & e_2 \triangleright_{\Gamma} \hat{e}_2  }
	   \\[3ex] 
