...
TSL1        :body
          ...
          :div[id="search"]
            Search again: {TSL1 SearchBox(STR"Go!"STR) TSL1}
...
TSL1`literal body here, ``inner backticks`` must be doubled`TSL1
TSL2'literal body here, ''inner single quotes'' must be doubled'TSL2
TSL3"literal body here, ""inner double quotes"" must be doubled"TSL3
{TSL4literal body here, {inner braces} must be balancedTSL4}
[TSL5literal body here, [inner brackets] must be balancedTSL5]
<TSL6literal body here, <inner angle brackets> must be balancedTSL6>
