...
To further motivate our approach, we performed a small empirical study that examined potential usage of the proposed language composition mechanism. For this purpose, we looked at the recent version of 107 Java projects in the Qualitas Corpus~\cite{QualitasCorpus:APSEC:2010} and performed two analysis to see how TSLs could be used directly and indirectly.
