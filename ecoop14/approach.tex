...
\todo{The symbols in figure Wyvern Example Backend before and after :body and :style and on the rest of the line 12 are gibberish on Windows and MiKTeX.}
