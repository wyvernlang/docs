...
\infer[\textit{T-lit}]
	  ...
	  {\begin{array}{c}
	   ...
	   i_m.parser.parse(i_{ps}) \Downarrow \keyw{iinj}[OK]((i_{ast}, i'_{ps}))\\
	   i_{ast} \uparrow \ih~~~~
