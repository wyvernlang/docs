...
\inferrule*[right=InstLVar]{
	\Gamma \vdash \botbound \sigbndl \betahat \dashv \Delta
}
{
	\Gamma[\betahat],
...
\inferrule*[right=InstLReach]{
	\Gamma \vdash \alphahat \sigbndr \topbound \dashv \Delta
}
{
	\Gamma[\alphahat],
...
\inferrule*[right=InstRVar]{
	\Gamma \vdash \betahat \sigbndr \topbound \dashv \Delta
}
{
	\Gamma[\betahat],
...
\inferrule*[right=InstRReach]{
	\Gamma \vdash \botbound \sigbndl \alphahat \dashv \Delta
}
{
	\Gamma[\alphahat],
